...
export default function NotFound() {
  return (
    <section className="flex min-h-[70vh] items-center bg-mist pt-[var(--header-h)]">
      <div className="mx-auto max-w-[76rem] px-6 py-24 text-center lg:px-8">
        <Mark className="mx-auto w-20" animate="draw" />
        <p className="label mt-10 text-slate">404</p>
        <h1 className="mt-4 text-h2 text-navy sm:text-h1">This page isn&rsquo;t here.</h1>
