...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden bg-mist pb-20 pt-[calc(var(--header-h)+4rem)] lg:pb-28 lg:pt-[calc(var(--header-h)+6rem)]">
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto max-w-[76rem] px-6 lg:px-8">
        ...
        <h1 className="mt-6 max-w-4xl text-[clamp(2.25rem,5.5vw,3.5rem)] font-semibold leading-[1.05] tracking-[-0.03em] text-navy">
        ...
        {lede ? (
          <motion.div
            className="mt-8 max-w-2xl text-[clamp(1.0625rem,2vw,1.25rem)] leading-[1.55] text-slate"
