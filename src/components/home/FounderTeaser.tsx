        ...
        <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-24">
          <Parallax speed={0.06} className="order-2 lg:order-1">
            <div className="relative">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[2rem] bg-raised">
                <Photo
          ...
          <div className="order-1 lg:order-2">
            ...
            <Reveal delay={0.06}>
              <h2 className="mt-3 text-h2 text-surf sm:text-h1">{founder.name}</h2>
            </Reveal>
            <GreenRule className="mt-5" delay={0.12} />
            <Reveal delay={0.16}>
              <p className="mt-7 text-body text-muted">{founder.blurb}</p>
            </Reveal>

            <Reveal delay={0.22}>
              <p className="label mt-10 text-muted">Awards &amp; milestones</p>
            </Reveal>
            <Stagger as="ul" className="mt-5 space-y-3" gap={0.06}>
              {awards.map((line) => (
                <StaggerItem key={line} as="li">
                  <div className="flex gap-3 text-[0.9375rem] text-surf">
                    <span
                      aria-hidden="true"
